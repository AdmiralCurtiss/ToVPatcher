...
SET source=EP_210_030
SET target=JUD_C001_EVT01
...
REM remove files
rd /S /Q %source%.DAT.dec.ext\0000.ext\ENPC
rd /S /Q %source%.DAT.dec.ext\0000.ext\NPC
rd /S /Q %source%.DAT.dec.ext\0000.ext\PC\JUD_C000
del /Q %source%.DAT.dec.ext\0000.ext\PC\JUD_C001\CUSTOM\JUD_C001_MET.*
