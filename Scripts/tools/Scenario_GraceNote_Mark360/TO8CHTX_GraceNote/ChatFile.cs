...
namespace TO8CHTX_GraceNote
{
    ...
    class ChatFile
    {
        ...
        public ScenarioString[] ToScenarioStringsFor360Check()
        {
            List<ScenarioString> list = new List<ScenarioString>(Lines.Length*2);

            foreach (ChatFileLine l in Lines)
            {
                list.Add(new ScenarioString(l.Location, l.SJPN, l.SENG));
                list.Add(new ScenarioString(l.Location+4, l.SJPN, l.SENG));
            }
