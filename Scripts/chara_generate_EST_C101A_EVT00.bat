...
SET source=EP_0372_030
SET target=EST_C101A_EVT00
...
rd /S /Q %source%.DAT.dec.ext\0000.ext\PC\JUD_C000
rd /S /Q %source%.DAT.dec.ext\0000.ext\PC\JUD_C002
rd /S /Q %source%.DAT.dec.ext\0000.ext\PC\JUD_C005
rd /S /Q %source%.DAT.dec.ext\0000.ext\PC\JUD_C101
rd /S /Q %source%.DAT.dec.ext\0000.ext\PC\PAT_C000
rd /S /Q %source%.DAT.dec.ext\0000.ext\PC\PAT_C101
...
del /Q %source%.DAT.dec.ext\0002.ext\*
